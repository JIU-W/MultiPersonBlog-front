<template>
  <div>
    <div class="search">
      ...
      <el-input placeholder="请输入用户名称查询" style="width: 200px; margin-right: 10px;" v-model="userName"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="tags" label="标签">
          <!-- <template v-slot="scope">
            <el-tag v-for  = " item in JSON.parse(scope.row.tags || '[]')">{{item}}</el-tag>
          </template> -->
          <template v-slot="scope">
